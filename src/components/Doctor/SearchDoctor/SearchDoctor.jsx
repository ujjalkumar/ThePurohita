...
const SearchDoctor = () => {
    ...
    if (!isLoading && !isError && doctorsData && doctorsData.length > 0) content =
        <>
            {
    ...
    return (
        <div>
            <Header />
            <SubHeader title='Purohitas' subtitle='Our Esteemed Purohitas – Experienced, Knowledgeable, and Devoted.' />
